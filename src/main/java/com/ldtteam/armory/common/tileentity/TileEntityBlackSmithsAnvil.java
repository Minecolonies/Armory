...
import com.ldtteam.armory.common.block.BlockBlackSmithsAnvil;
import com.ldtteam.armory.common.crafting.blacksmiths.recipe.VanillaAnvilRecipe;
import com.ldtteam.armory.common.tileentity.guimanagers.TileEntityBlackSmithsAnvilGuiManager;
import com.ldtteam.armory.common.tileentity.state.TileEntityBlackSmithsAnvilState;
 ...
 */
public class TileEntityBlackSmithsAnvil extends TileEntitySmithsCore<TileEntityBlackSmithsAnvilState, TileEntityBlackSmithsAnvilGuiManager> implements IItemStorage, ITickable, com.ldtteam.smithscore.common.tileentity.IWatchableTileEntity {
    ...
    public void clearInventory() {
        com.ldtteam.armory.api.util.common.ItemStackHelper.InitializeItemStackArray(craftingStacks);
        com.ldtteam.armory.api.util.common.ItemStackHelper.InitializeItemStackArray(outputStacks);
        com.ldtteam.armory.api.util.common.ItemStackHelper.InitializeItemStackArray(hammerStacks);
        com.ldtteam.armory.api.util.common.ItemStackHelper.InitializeItemStackArray(tongStacks);
        com.ldtteam.armory.api.util.common.ItemStackHelper.InitializeItemStackArray(additionalCraftingStacks);
        com.ldtteam.armory.api.util.common.ItemStackHelper.InitializeItemStackArray(coolingStacks);
    }
