...
import com.ldtteam.armory.common.tileentity.guimanagers.TileEntityMoltenMetalMixerGuiManager;
import com.ldtteam.armory.common.tileentity.state.TileEntityMoltenMetalMixerState;
...
public class TileEntityMoltenMetalMixer extends TileEntitySmithsCore<TileEntityMoltenMetalMixerState, TileEntityMoltenMetalMixerGuiManager> implements ITickable, IFluidContainingEntity, IItemStorage {
    ...
    public boolean isItemValidForSlot(int index, @Nonnull ItemStack stack) {
        ...
        {
            if (com.ldtteam.smithscore.util.common.helper.ItemStackHelper.equalsIgnoreStackSize(stack, recipe.getPrimarySolidInputStack())
                  && com.ldtteam.smithscore.util.common.helper.ItemStackHelper.equalsIgnoreStackSize(stack, recipe.getSecondarySolidInputStack())
                    && com.ldtteam.smithscore.util.common.helper.ItemStackHelper.equalsIgnoreStackSize(stack, recipe.getTertiarySolidInputStack()))
            {
                    return true;
            }
        }
