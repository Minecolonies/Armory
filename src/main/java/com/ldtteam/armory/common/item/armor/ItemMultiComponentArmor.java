package com.ldtteam.armory.common.item.armor;

import com.google.common.collect.Lists;
import com.ldtteam.armory.api.IArmoryAPI;
import com.ldtteam.armory.api.client.render.provider.model.IModelProvider;
...
import static com.ldtteam.armory.api.util.client.TranslationKeys.Items.MultiArmor.Armor.TK_BROKEN;
import static com.ldtteam.armory.api.util.client.TranslationKeys.Items.MultiArmor.Armor.TK_DURABILTIY;
...
public class ItemMultiComponentArmor extends Item implements ISpecialArmor, IModelProvider
{
    ...
    {
        return com.ldtteam.smithscore.client.proxy.CoreClientProxy.getMultiColoredFontRenderer();
    }
