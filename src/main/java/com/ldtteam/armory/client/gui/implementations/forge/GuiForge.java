...
import com.ldtteam.smithscore.client.gui.components.implementations.*;
...
public class GuiForge extends GuiContainerSmithsCore {
    ...
    public void registerComponents(@Nonnull IGUIBasedComponentHost host) {
        ...
        host.registerNewComponent(new ComponentPlayerInventory(References.InternalNames.GUIComponents.Forge.INVENTORY, host, new Coordinate2D(0, 80), com.ldtteam.armory.api.util.client.Colors.DEFAULT, ((ContainerSmithsCore) inventorySlots).getPlayerInventory(), ComponentConnectionType.BELOWDIRECTCONNECT));
