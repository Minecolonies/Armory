package com.ldtteam.armory.client.gui.implementations.moltenmetalmixer;
...
import com.ldtteam.smithscore.client.gui.components.implementations.ComponentFluidTank;
...
import static com.ldtteam.armory.api.util.references.References.InternalNames.GUIComponents.MoltenMetalMixer.*;
...
public class GuiMoltenMetalMixer extends GuiContainerSmithsCore {
    ...
    public void registerComponents(@Nonnull IGUIBasedComponentHost host) {
        host.registerNewComponent(new ComponentBorder(CPN_BACKGROUND, host, new Coordinate2D(0, 0), GUI.getWidth(), 111, com.ldtteam.armory.api.util.client.Colors.DEFAULT, ComponentBorder.CornerTypes.Inwards, ComponentBorder.CornerTypes.Inwards, ComponentBorder.CornerTypes.Inwards, ComponentBorder.CornerTypes.Inwards));
        host.registerNewComponent(new ComponentPlayerInventory(CPN_INVENTORY, host, new Coordinate2D(0, 107), com.ldtteam.armory.api.util.client.Colors.DEFAULT, ((ContainerSmithsCore) inventorySlots).getPlayerInventory(), ComponentConnectionType.BELOWDIRECTCONNECT));
