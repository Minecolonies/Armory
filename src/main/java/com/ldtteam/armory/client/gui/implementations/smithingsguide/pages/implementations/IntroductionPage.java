package com.ldtteam.armory.client.gui.implementations.smithingsguide.pages.implementations;
...
import com.ldtteam.armory.client.gui.implementations.smithingsguide.pages.core.AbstractPage;
...
import static com.ldtteam.armory.api.util.client.TranslationKeys.Gui.Guide.Introduction.*;
...
public class IntroductionPage extends AbstractPage
{
    ...
    public void registerPageContents(@Nonnull final ComponentContentArea host)
    {
        ...
        host.registerNewComponent(new ComponentItemStackDisplay(host.getID() + ".header.itemstack.right", host, new CoreComponentState(), new Coordinate2D(pageSizeWidth - 32,0), HeatedItemFactory
                                                                                                                                                                                    .getInstance().generateHeatedItemFromMaterial(ModMaterials.Armor.Core.HARDENED_IRON, ModHeatableObjects.ITEMSTACK, ModHeatedObjectTypes.INGOT, 350f))
        {
            @Nullable
            @Override
            public ArrayList<String> getToolTipContent()
