...
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Defence.Medieval.ChestPlate.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Defence.Medieval.Helmet.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Defence.Medieval.Leggings.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Defence.Medieval.Shoes.DEF_LACESLEFT;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Defence.Medieval.Shoes.DEF_LACESRIGHT;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Durability.Medieval.ChestPlate.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Durability.Medieval.Helmet.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Durability.Medieval.Leggings.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Durability.Medieval.Shoes.DUR_LACESLEFT;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Durability.Medieval.Shoes.DUR_LACESRIGHT;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Toughness.Medieval.ChestPlate.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Toughness.Medieval.Helmet.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Toughness.Medieval.Leggings.*;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Toughness.Medieval.Shoes.TOU_LACESLEFT;
import static com.smithsmodding.armory.api.util.references.ModData.Addons.Toughness.Medieval.Shoes.TOU_LACESRIGHT;
import static com.smithsmodding.armory.api.util.references.ModData.Armor.Defence.*;
import static com.smithsmodding.armory.api.util.references.ModData.Armor.Ratio.*;
import static com.smithsmodding.armory.api.util.references.ModData.Armor.Toughness.*;
