 ...
 */
public class ArmorModelLayerPartDefinition
{
    ...
    /**
     * Constructor for a new {@link ArmorModelLayerPartDefinition}.
     ...
     */
    public ArmorModelLayerPartDefinition(@Nonnull final ResourceLocation id, @Nonnull final ResourceLocation textureLocation, @Nonnull final TRSRTransformation transformation) {
        this.id = id;
     ...
     */
    public ArmorModelLayerPartDefinition createOverride(@Nonnull final ResourceLocation newTextureLocation) {
        if (newTextureLocation.equals(getTextureLocation()))
        {
            return this;
        }

        return new ArmorModelLayerPartDefinition(getId(), newTextureLocation, new TRSRTransformation(getTransformation().getMatrix()));
    }
}
